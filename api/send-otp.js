export default async function handler(req, res) {
  ...
  const message = `Your KaziApa verification code is: ${otp}. Valid for 10 minutes. Do not share this code with anyone.`;
  ...
  try {
    ...
    console.log("AT Live Response:", JSON.stringify(smsData));
