              ...
              myPosted.map(r=>(
                <div key={r.id} onClick={()=>setViewReq(r)} style={{ background:T.card, borderRadius:14, padding:14, marginBottom:10, border:`1px solid ${T.border}`, cursor:"pointer" }}>
                  ...
                  {r.provider_phone && r.status!=="open" && (
                    <a href={`tel:${r.provider_phone}`} onClick={e=>e.stopPropagation()} style={{ display:"block", textAlign:"center", marginTop:10, padding:10, background:T.successSoft, color:T.success, border:"none", borderRadius:11, fontSize:13, fontWeight:700, textDecoration:"none" }}>
                      📞 Call {r.provider_name||"Provider"}
                    </a>
                  )}
                  {r.status==="delivered" && (
              ...
              myAccepted.map(r=>(
                <div key={r.id} style={{ background:T.card, borderRadius:14, padding:14, marginBottom:10, border:`1px solid ${T.border}` }}>
                  ...
                  {r.customer_phone && (r.status==="accepted"||r.status==="delivered") && (
                    <a href={`tel:${r.customer_phone}`} onClick={e=>e.stopPropagation()} style={{ display:"block", textAlign:"center", marginTop:10, padding:10, background:T.successSoft, color:T.success, border:"none", borderRadius:11, fontSize:13, fontWeight:700, textDecoration:"none" }}>
                      📞 Call {r.customer_name||"Customer"}
                    </a>
                  )}
                  {r.status==="accepted" && (
        ...
        <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.5)", zIndex:100, display:"flex", alignItems:"flex-end" }} onClick={()=>setViewReq(null)}>
          <div style={{ background:"#fff", borderRadius:"20px 20px 0 0", padding:20, width:"100%", maxHeight:"80vh", overflowY:"auto" }} onClick={e=>e.stopPropagation()}>
            ...
            {viewReq.provider_phone && viewReq.status!=="open" && (
              <a href={`tel:${viewReq.provider_phone}`} style={{ display:"block", textAlign:"center", marginTop:10, padding:11, background:T.successSoft, color:T.success, border:"none", borderRadius:11, fontSize:14, fontWeight:700, textDecoration:"none" }}>
                📞 Call {viewReq.provider_name||"Provider"}
              </a>
            )}
