...
function MarketProfileScreen({ market, phone, userName, showToast, onBack, onAddBusiness, onRequestGuide }) {
  ...
  return (
    <div>
      <BackHeader title={market.name} onBack={onBack} />
      <div style={{ padding:16 }}>
        <div style={{ background:T.card,borderRadius:13,padding:14,border:`1px solid ${T.border}`,marginBottom:16 }}>
          ...
          {!joined && <button onClick={openRolePicker} style={{ marginTop:12,width:"100%",padding:11,background:T.primary,color:"#fff",border:"none",borderRadius:11,fontWeight:700,fontSize:13,cursor:"pointer" }}>+ Join This Market</button>}
          {joined && (
        ...
        <div style={{ display:"flex",gap:6,marginBottom:16,overflowX:"auto" }}>
          {[{k:"directory",l:"🏪 Directory"},{k:"shop",l:"🛒 Shop"},{k:"requests",l:"📋 Requests"},{k:"jobs",l:"💼 Jobs"},{k:"services",l:"🔧 Services"},{k:"transport",l:"🚚 Transport"},{k:"guides",l:"🧭 Guides"},{k:"notices",l:"📢 Notices"},{k:"spaces",l:"🏬 Spaces"},{k:"info",l:"ℹ️ Info"}].map(t=>(
          ...
          <div>
            ...
            {loading ? <div style={{ padding:30,textAlign:"center",color:T.textMuted }}>Loading...</div> : kiosks.length===0 ? (
              <div style={{ textAlign:"center",padding:"30px 0" }}>
                ...
                <div style={{ fontWeight:700,color:T.text,marginTop:10,fontSize:14 }}>No businesses here yet</div>
                <div style={{ fontSize:12,color:T.textMuted,marginTop:4 }}>Be the first business to join this market.</div>
