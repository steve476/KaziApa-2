...
const NON_KIOSK_ROLES = ["Buyer","Worker"]; // roles that don't imply "I have a stall/business here"
      ...
      {showRoleModal && (
        <div style={{ position:"fixed",inset:0,background:T.overlay,zIndex:100,display:"flex",alignItems:"flex-end" }} onClick={()=>setShowRoleModal(false)}>
          <div style={{ background:T.card,borderRadius:"20px 20px 0 0",padding:20,width:"100%",maxHeight:"75vh",overflowY:"auto" }} onClick={e=>e.stopPropagation()}>
            {modalStep==="roles" ? (
              <>
                <div style={{ fontWeight:800,fontSize:16,color:T.text,marginBottom:4 }}>What do you do in {market.name}?</div>
                ...
                <Btn onClick={confirmRoles} disabled={savingRoles}>{savingRoles?"Saving...":joined?"Update Roles →":"Join Market →"}</Btn>
