...
export default function KaziApa() {
  ...
  return (
    <div style={{ fontFamily:"'Segoe UI',system-ui,sans-serif",background:T.surface,minHeight:"100vh",maxWidth:430,margin:"0 auto",position:"relative",paddingBottom:72 }}>
      ...
      {screen==="about" && <LegalScreen title="ℹ️ About KaziApa" onBack={()=>nav("profile","profile")} sections={ABOUT_SECTIONS} />}
...
const ABOUT_SECTIONS = [
  ["Our Story", "KaziApa was built in Nakuru, Kenya to solve a simple problem: finding a job, a house, a fundi, or a buyer in your town should not require knowing the right people or travelling to the market. KaziApa brings your local market online — free, fast, and accessible from any phone."],
  ["Our Mission", "To connect every Kenyan town's buyers, sellers, workers, and service providers in one trusted platform — making the informal economy more organised, more efficient, and more profitable for everyone."],
  ...
  ["Our Company", "KaziApa is a product of Kazinasi Technologies, a Kenyan-registered business (Certificate BN-MJS7EOL7) based in Nakuru. We are a small team building tools for Kenya's informal economy."],
  ["Our Values", "Honesty — we never claim to do things we cannot do yet. Trust — we build features that protect users, not exploit them. Local first — we build for Kenyan towns, not Silicon Valley. Accessibility — free to use, works on any Android phone with any data plan."],
  ["Contact Us", "Email: hello@kaziapa.co.ke | Website: kaziapa.co.ke | Location: Nakuru, Kenya"],
];
...
function ContactScreen({ onBack }) {
  const CONTACTS = [
    ...
    { icon:"📍", label:"Location",           value:"Nakuru, Kenya",           href:null },
  ];
  return (
    <div>
