        ...
        <div>
          ...
          <div style={{ padding:16 }}>
            {[
              ...
              { icon:"🚪",label:"Log Out",            action:()=>{ localStorage.removeItem("kaziapa_user"); sessionStorage.removeItem("kaziapa_screen"); sessionStorage.removeItem("kaziapa_nav"); setAuthStep("phone"); setUserName(""); setPhone(""); setOtp(["","","","","",""]); } },
            ].map((item,i)=>(
