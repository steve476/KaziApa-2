    ...
    <div>
      ...
      <div style={{ padding:16 }}>
        ...
        <div style={{ display:"flex",gap:6,marginBottom:16,overflowX:"auto" }}>
          {[{k:"directory",l:"🏪 Directory"},{k:"shop",l:"🛒 Shop"},{k:"requests",l:"📋 Requests"},{k:"jobs",l:"💼 Jobs"},{k:"services",l:"🔧 Services"},{k:"guides",l:"🧭 Guides"},{k:"notices",l:"📢 Notices"},{k:"info",l:"ℹ️ Info"}].map(t=>(
        ...
        {tab==="info" && (
          <div style={{ fontSize:13,color:T.textMid,lineHeight:1.7 }}>
            ...
            <div style={{ marginTop:12,fontSize:11,color:T.textMuted }}>Transport and Shops & Spaces for this market are coming in a future update.</div>
          </div>
        )}
      </div>
