  ...
  return (
    <div onClick={onClick} style={{ background:T.card,borderRadius:14,marginBottom:10,cursor:"pointer",border:listing.boosted?`1.5px solid ${T.accent}`:`1px solid ${T.border}`,overflow:"hidden",display:"flex" }}>
      ...
      <div style={{ padding:"10px 12px",flex:1,minWidth:0 }}>
        ...
        <div style={{ fontSize:11,color:T.textMuted,marginTop:2 }}>📍 {listing.town} · {listing.seller_name}{listing._distanceKm!=null ? ` · ${listing._distanceKm<1 ? Math.round(listing._distanceKm*1000)+"m" : listing._distanceKm.toFixed(1)+"km"} away` : ""}</div>
