          ...
          {dStep===3 && (
            <div>
              ...
              <div style={{ background:T.card,borderRadius:14,padding:16,marginBottom:14,border:`1px solid ${T.border}` }}>
                {[["Item",listing?.title],["Seller",listing?.seller_name],["Item price",`Ksh ${listing?.price?.toLocaleString()}`],["Delivery",`Ksh ${delCost}`],...(rider&&!rider.bus?[["Rider",rider.name]]:rider?.bus?[["Service",rider.name]]:[])].map(([k,v])=>(
              ...
              <div style={{ background:T.accentSoft,borderRadius:12,padding:12,marginBottom:16,fontSize:12,color:T.accentDark }}>💡 Pay the rider/seller directly on delivery or via M-Pesa. Confirm item condition before paying in full.</div>
